...
protocol ColorPickerContentViewControllerDelegate: AnyObject {
    ...
    func colorPickerViewControllerDidCheck(_ viewController: ColorPickerContentViewController)
}
...
class ColorPickerContentViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(
            image: UIImage(systemName: "checkmark")?.withTintColor(.black, renderingMode: .alwaysTemplate),
            primaryAction: UIAction { [unowned self] _ in
                self.delegate?.colorPickerViewControllerDidCheck(self)
            }
        )
